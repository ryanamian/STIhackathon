						        ...
						        <?php
									...
									$delivery_date=  $row->transaction_delivery_date;
										...
										echo'<tr id="' . $transactionID . '">
								                ...
								                <td>' . $name . '</td>
								                <td>' . $delivery_date . '</td>
								                <td><a href="' .base_url() .'transaction/view_delivery_receipt/'. $transactionID .'" class="btn btn-success btn-xs btn_view_delivery">View</a><a data-toggle="modal" data-target="#' . $transactionID . '_modaldelivered" class="btn btn-success btn-xs">Delivered</a></td>
								            </tr>';
													     	...
													     	<div class="modal-body">
																...
																<div id="message">
																	...
																	<div id="delivered_message">
																		<div class="redirect_info">Are you sure it is delivered?</div>
