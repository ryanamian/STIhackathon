<div id="report_rent_view">
	...
	<div id="box">
		...
		<div class="box-top"><img src="<?php echo base_url();?>images/admin_images/rent.png"> Rent report</div>
			<div class="box-panel">
				<form method="POST" id="rent_form" action="<?php echo base_url();?>reports/rent_reports_fromto/">
			...
			<div id="report_rent_table" class="row">
			    <table id="report_rent_list" class="table table-hover table table-striped">
			        ...
			        <tbody>
			        	<?php 
			        		...
			        		foreach ($rent->result()as $object) {
			        			...
			        			$date_rented = $object->date_rented;
			        			$size_convert = '';	
			        			if(strpos($size, '-') == TRUE){
					...
					<div class="col-md-2 col-md-offset-10">
						...
						<?php
							if(isset($date1) && isset($date2)){
								...
								echo '<a href="'. base_url() . 'reports/report_rent_download/' . $date1 . '/' . $date2 . '" class="btn btn-success">Download This Reports</a>';	
							}else{
								echo '<a href="'. base_url() . 'reports/report_rent_download/" class="btn btn-success">Download This Reports</a>';
							}
