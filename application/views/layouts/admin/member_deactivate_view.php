		<div class="member_list_deactivate">		
			<div id="box">
				<div class="box-top"><img src="<?php echo base_url();?>images/admin_images/member.png">Member list</div>
				...
				<div class="box-panel">
					...
					<div class="table-responsive">
					    <table id="table_member_deactivate_view" class="table table-hover table table-striped">
					        <thead>
					            <tr>
					                <th>First Name</th>
					                <th>Last Name</th>
					        ...
					        <?php
					        	...
					        	foreach ($query->result() as $row) {
									...
									echo'<tr id="' . $userid . '">
							                ...
							                <td>' . $lname . '</td>
							                <td>' . $email . '</td>
							                <td><a href="' . base_url() . 'admin/activate_member?userid=' . base64_encode($userid) . '" class="activate_btn btn btn-success btn-xs">Activate</a><a href="' . base_url() . 'admin/member_info/' . $userid . '" class="btn btn-success btn-xs">View</a></td>
							            </tr>';
								}
							?>
					        </tbody>
					    ...
					    <a href="<?php echo base_url();?>admin/member" class="btn btn-success btn-xs">View Activated Account</a>
						<?php
...
<script>
	$(".activate_btn").click(function(evt){
   		evt.preventDefault();
